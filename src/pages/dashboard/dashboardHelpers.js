...
{
    $limit: 1000,
    $select: ['status', 'shortDescription', 'price', 'locationName', 'openHour', 'startDate', '_id', 'location', 'locationInfo', 'tags', 'tagsIds', 'createdAt', 'name', 'shortDescription', 'authorityId', 'authority', 'contactPersonPhoneNumber', 'galleryFileIds']
}
