...
export const UploadMediaTab = ({ media, setMedia, initialData, tab, setLoadingImage }) => {
              ...
              <>
                ...
                <DialogContent key={index}>
                  <div style={{display: 'flex', alignItems: "center", justifyContent: 'center'}}>
                    <DragDrop setLoadingImage={setLoadingImage} media={media} showImage={showImage} setShowImage={setShowImage} mediaType={type} setArr={setMedia} fileTypes={fileTypes} initialData={initialData} tab={tab}/>
                  </div>
