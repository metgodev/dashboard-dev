...
export const ModalInit = [
    ...
    { title: term('hours_close'), id: 7, field: 'hours close', rows: 4, maxRows: 1, size: 'small', type: 'timePicker' },
    { title: term('for_whom'), id: 8, field: 'relevantTo', rows: 1, maxRows: 1, size: 'small', type: 'picker' },
    { title: term('how_much'), id: 9, field: 'howMuch', rows: 4, maxRows: 1, size: 'small', type: 'textfield' },
    { title: term('producer'), id: 10, field: 'producer', rows: 4, maxRows: 1, size: 'small', type: 'textfield' },
    ...
    { title: term('description'), id: 16, field: 'description', rows: 1, maxRows: 4, size: 'small', type: 'textfield' },
