...
export const ModalInit = [
    ...
    { title: term('business_number'), id: createRandomId(), field: 'phoneNumber', rows: 1, maxRows: 4, size: 'medium', type: 'textfield', required: true },
    { title: term('phone_number_whatsapp'), id: createRandomId(), field: 'whatsAppPhoneNumber', rows: 1, maxRows: 4, size: 'medium', type: 'textfield', required: true },
    ...
    { title: term('approve_content'), id: createRandomId(), field: 'approveContent', rows: 1, maxRows: 4, size: 'medium', type: 'checkbox', required: false },
    //------------------ More Information ------------------ 
